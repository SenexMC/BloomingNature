...
public class ModChestBoatEntity extends ChestBoat {
    ...
    public @NotNull Item getDropItem() {
        return switch (getModVariant()) {
            case ASPEN -> BoatRegistry.ASPEN_CHEST_BOAT.get();
            case LARCH -> BoatRegistry.LARCH_CHEST_BOAT.get();
            case SWAMP_OAK -> BoatRegistry.SWAMP_OAK_CHEST_BOAT.get();
            case BAOBAB -> BoatRegistry.BAOBAB_CHEST_BOAT.get();
            case FAN_PALM -> BoatRegistry.FAN_PALM_CHEST_BOAT.get();
            case FIR -> BoatRegistry.FIR_CHEST_BOAT.get();
            case SWAMP_CYPRESS -> BoatRegistry.SWAMP_CYPRESS_CHEST_BOAT.get();
            case CHESTNUT -> BoatRegistry.CHESTNUT_CHEST_BOAT.get();
            case EBONY -> BoatRegistry.EBONY_CHEST_BOAT.get();
        };
    }
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(DATA_ID_TYPE, ModBoatEntity.Type.ASPEN.ordinal());
    }
